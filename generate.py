...
pages = {
    ...
    <section class="section privacy">
      <div class="container">
        <div class="content-box">
          <h2 class="privacy-title" style="margin-bottom: 24px;">プライバシーポリシー（個人情報の取扱い）</h2>
          <p style="margin-bottom: 32px;">当法人では個人情報の重要性を認識し、その保護の徹底を図るため、個人情報保護法に関する法令と社会秩序を尊重･遵守し、利用者様に関する個人情報について、以下の考え方に沿って、適正な取り扱いと保護･管理に努めます。</p>

          <h3 class="privacy-title">1. 利用目的について</h3>
          <p>利用者様の個人情報は、以下の目的のために取得・利用させていただきます。<br>
          （1) 利用のお申し込みに関する契約の履行及び関連する情報、サービス、契約後のアフターサービスの提供<br>
          （2）利用者様動向分析<br>
          （3）利用者様にとって有用と思われるサービス等の紹介<br>
          （4）（1）の利用目的の達成の範囲での、個人情報の外部への提供</p>

          <h3 class="privacy-title">2. ご同意いただきたいこと</h3>
          <p>個人情報に関する次の事項にご同意のうえ、利用契約をお申し込みください。ご同意いただけない場合は各種サービスへのお申し込みは見合わせていただきます。あらかじめご了承のほどお願い申し上げます。</p>

          <h3 class="privacy-title">3. 情報の管理方法</h3>
          <p>当法人では個人情報の取り扱いの一部を適切に取り扱っていると認められる外部の委託先に委託しています。委託先は、委託業務を行うために必要な範囲で個人情報を利用します。</p>

          <h3 class="privacy-title">4. 外部への提供</h3>
          <p>その他、上記１．に掲げる利用目的の範囲内で外部に個人情報を提供する場合があります。<br>
          （1）あらかじめご本人が同意されている場合<br>
          （2）その他法令に根拠がある場合</p>

          <h3 class="privacy-title">5. 利用者様からの開示、訂正、利用停止のご請求</h3>
          <h4 class="privacy-subtitle" style="margin-top: 16px; margin-bottom: 8px;">（開示・訂正）</h4>
          <p>利用者様からご自身に関する情報の開示のご依頼があった場合は、ご本人であることをご確認させていただいたうえで特別な理由が無い限りお答えさせていただきます。<br>
          また、利用者様に関する情報が間違っている場合においては、訂正させていただきます。</p>
          <h4 class="privacy-subtitle" style="margin-top: 16px; margin-bottom: 8px;">（利用停止）</h4>
          <p>利用者様は、利用者様の個人情報の利用や外部への提供について利用者様がご希望されない場合は申し出てください。ただし、利用・第三者への提供の停止の結果、サービスの提供が利用できなくなる場合があります。</p>

          <div style="margin-top: 60px; padding-top: 20px; border-top: 1px solid #ddd;">
          <p><a href="https://www.swsc-ship.com/privacy-policy/" target="_blank" rel="noopener noreferrer">社会福祉法人SHIP公式サイトの個人情報保護方針 <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle; margin-left: 2px;"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg></a></p>
          </div>
        </div>
      </div>
    </section>
